...
const Hospitals = () => {
  const hospitals = [
    ...
    },
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1565262353342-6e919eab5b58?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      services: [
        "General Medicine",
        "Pediatrics",
        "General Surgery",
